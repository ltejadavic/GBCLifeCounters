...
#define DETAIL_FIELD_COMMANDER 0u
#define DETAIL_FIELD_LIFE 1u
#define DETAIL_FIELD_POISON 2u
#define DETAIL_FIELD_RAD 3u
#define DETAIL_FIELD_COMMANDER_DAMAGE 4u
#define DETAIL_FIELD_MONARCH 5u
#define DETAIL_FIELD_INITIATIVE 6u
#define DETAIL_FIELD_COUNT 7u
